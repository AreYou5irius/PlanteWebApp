...
new Vue({
    ...
    methods: {
        ...
        async getAllPlanterAsync() {
            try {
                return _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(baseUrl);
            }
            catch (error) {
        ...
        async getPlanteById(id) {
            let response = await this.getPlanteByIdAsync(id);
            this.singlePlanteId = response.data;
        },
        async getPlanteByIdAsync(id) {
            let url = baseUrl + "/" + id;
            try {
                return _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(url);
            }
            catch (error) {
                this.message = error.message;
                alert(error.message);
        ...
        async getPlanteByType(type) {
            let response = await this.getPlanteByTypeAsync(type);
            this.singlePlanteType = response.data;
        },
        async getPlanteByTypeAsync(type) {
            let url = baseUrl + "/planteType/" + this.planteType;
            try {
                return _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(url);
            }
            catch (error) {
        ...
        async addPlanteAsync() {
            try {
                return _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUrl, this.formData);
            }
            catch (error) {
                this.message = error.message;
                alert(error.message);
        ...
        async deletePlanteById(id) {
            await this.deletePlanteByIdAsync(id);
            this.deleteMessage = "planten er slettet";
        },
        async deletePlanteByIdAsync(id) {
            let url = baseUrl + "/" + id;
            try {
                return _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.delete(url);
            }
            catch (error) {
                this.message = error.message;
                alert(error.message);
